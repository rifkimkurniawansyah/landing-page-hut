    ...
    return (
        <section>
            <header className="bg-[#182b66] py-6 flex items-center justify-between">
                ...
                <div className="hidden md:flex w-full justify-center pr-4 gap-8 text-lg font-bold text-white cursor-pointer">
                    <p>
            ...
            {isOpen && (
                <div className="relative">
                    <nav className="absolute w-full md:hidden bg-[#182b66] text-white text-lg font-semibold rounded-b-md">
                        <ul className="flex flex-col items-center gap-4 py-4 z-10">
                            <li>
