...
export default function SejarahKemerdekaan() {
  return (
    <section id="sejarah" className="mx-auto relative overflow-hidden">
      ...
      <div className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-1 before:bg-gradient-to-b before:from-transparent before:via-red-600 before:to-transparent mt-12 px-24">
        <ScrollAnimation
          ...
          <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-slate-50 p-4 rounded border border-slate-200 shadow bg-opacity-90">
            ...
            <div className="text-slate-700">
              <ul className="list-disc ml-4">
                <li>
                  1602: Pendudukan Belanda dimulai dengan pembentukan Vereenigde
                  Oost-Indische Compagnie (VOC), yang menjadi kekuatan utama di
                  Indonesia.
                </li>
                <li>
        ...
        >
          ...
          <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-slate-50 p-4 rounded border border-slate-200 shadow bg-opacity-90">
            <div className="flex items-center justify-between space-x-2 mb-1">
              <div className="font-bold text-slate-900">Pendudukan Jepang</div>
              <time className="font-caveat font-medium text-red-500">
                1942-1945
              </time>
            </div>
            <div className="text-slate-700">
              <ul className="list-disc ml-4">
                ...
                <li>
                  1945: Pendudukan Jepang berakhir dengan kekalahan Jepang dalam
                  Perang Dunia II.
                </li>
              </ul>
            </div>
          ...
          <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-slate-50 p-4 rounded border border-slate-200 shadow bg-opacity-90">
            ...
            <div className="text-slate-700">
              <ul className="list-disc ml-4">
                ...
                <li>
                  16 Oktober 1911: Sarekat Islam didirikan oleh Haji Samanhudi,
                  menjadi salah satu organisasi pergerakan terbesar yang
                  memperjuangkan hak-hak sosial dan politik.
                </li>
                <li>
        ...
        >
          ...
          <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-slate-50 p-4 rounded border border-slate-200 shadow bg-opacity-90">
            ...
            <div className="text-slate-700">
              ...
              kemerdekaan Indonesia di Jakarta pada pukul 10:00 WIB. Proklamasi
              ini merupakan tonggak utama kemerdekaan Indonesia dari penjajahan.
            </div>
            <img
              className="mt-4 mx-auto w-full rounded-xl"
        ...
        >
          ...
          <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-slate-50 p-4 rounded border border-slate-200 shadow bg-opacity-90">
            <div className="flex items-center justify-between space-x-2 mb-1">
              <div className="font-bold text-slate-900">Perang Kemerdekaan</div>
              <time className="font-caveat font-medium text-red-500">
                1945-1949
              </time>
            </div>
