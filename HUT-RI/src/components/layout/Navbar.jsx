...
const Navbar = () => {
  ...
  return (
      <header>
        ...
        {isOpen && (
            <nav
                className="flex flex-col space-y-8 justify-center items-end font-bold text-gray-900 absolute h-full z-40 left-0 bottom-0 w-full backdrop-blur-2xl p-4 md:hidden shadow-lg text-xl">
              <button
                  onClick={() => {
